                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 4.w),
                                      Text(
                                        '${getAverageValue(widget.foodItem.place)} (${widget.foodItem.place.reviewItems.length})',
                                        style: TextStyle(
                                          color: AppColors.blackgrey35Color,
                                          fontSize: 14.sp,
                  ...
                  children: [
                      ...
                      child: FormForButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => FoodCardInfoScreen(
                    ...
                    GestureDetector(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => FoodCardReviewsScreen(
                              placeItem: widget.foodItem.place,
                            ),
                          ),
                        );
                      },
                      child: Column(
                        children: [
                          RaytingWidget(
                            rayting: getAverageValue(widget.foodItem.place),
                            lengthRayting: widget.foodItem.place.reviewItems.length,
              ...
              GestureDetector(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: widget.foodItem.place.reviewItems.length,
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: ReviewCard(
                          reviewItem: widget.foodItem.place.reviewItems[index],
                        ),
                      );
                    },
                  ),
